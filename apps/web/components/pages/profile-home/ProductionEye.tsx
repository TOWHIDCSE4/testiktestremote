...
import { LuMenu, LuMoon, LuSettings, LuSettings2 } from "react-icons/lu"
...
export default function ProductionEyeComponent() {
  ...
  console.log("primaryLocationId", primaryLocationId)
                  ...
                  >
                    <div className="relative w-full h-full pl-2 pr-3 overflow-y-auto scrollbar-w-xs">
                      {selectedCompareLocations
                        ...
                        ?.sort((a, b) => {
                          return (
                            a.machineClass?.rowNumber - b.machineClass.rowNumber
                          )
                        })
