    ...
    <div className="order-last md:order-none mt-6 md:mt-0 ">
      ...
      >
        <div className="relative md:w-60 xl:w-80 2xl:w-[420px]">
          <Combobox.Input
            className={`block mt-2 md:w-60 xl:w-80 2xl:w-[420px] rounded-md border-0 py-1.5 pl-3 dark:bg-gray-300 bg-zinc-100 pr-10 text-gray-900 ring-1 ring-inset ring-gray-400 focus:ring-1 focus:ring-blue-950 sm:text-sm md:text-lg xl:text-[1.5vw] 2xl:text-3xl sm:xl:leading-7 disabled:opacity-50 disabled:cursor-not-allowed`}
      ...
      <select
        ...
        className={`block mt-2 w-full md:w-60 xl:w-80 2xl:w-[420px] rounded-md border-0 py-1.5 pl-3 pr-10 dark:bg-gray-300 bg-zinc-100 text-gray-900 ring-1 ring-inset ring-gray-400 focus:ring-1 focus:ring-blue-950 sm:text-sm md:text-lg xl:text-[1.5vw] 2xl:text-3xl sm:xl:leading-7`}
        onChange={(e) => {
      ...
      <div className="relative flex">
        ...
        <div className="absolute w-60 md:w-56 xl:w-[220px] 2xl:w-[272px] dark:bg-gray-300 h-[1px] mt-[26px] md:mt-[32px] xl:mt-[29px] 2xl:mt-[51px] ml-20 md:ml-24 xl:ml-[99px] 2xl:ml-[145px] bg-gray-400 "></div>
      </div>
      <div className="bg-gray-100 h-28 xl:h-40 2xl:h-45 mt-2 w-[321px] 2xl:w-[417px] p-2 dark:bg-gray-300 text-gray-800 overflow-auto">
        ...
        {readingMessages.map((item, index) => {
          return (
            <p key={index} className="text-md xl:text-lg 2xl:text-xl">
              {item}
            </p>
          )
        })}
