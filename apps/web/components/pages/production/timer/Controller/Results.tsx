...
const Results = ({
  ...
  return (
    <>
      ...
      <div className="units relative hidden md:block lg:absolute md:mt-[24vh] lg:mt-0 lg:bottom-[28vh] xl:bottom-[28vh] 2xl:bottom-[25vh] lg:right-12 lg:w-[500px] xl:w-[600px] 2xl:w-[760px]">
        <h6 className="text-right uppercase text-lg md:text-xl xl:text-[1.7vw] 2xl:text-3xl text-gray-500 font-semibold leading-none mb-28  dark:bg-dark-blue dark:text-white">
          Units Created
        </h6>
        <div className="flex absolute md:space-x-8 items-end md:right-0 top-0 mt-10">
          <div className="-translate-y-1.5 md:-translate-y-2 lg:-translate-y-3.5 md:w-[220px] lg:w-[31.25rem] xl:-translate-y-6">
            <h5 className="uppercase text-sm md:text-lg xl:text-[1.5vw] 2xl:text-3xl font-medium text-gray-800 mt-2 md:text-right xl:leading-6 grid-cols-4 grid justify-items-stretch">
              <label className="justify-self-end col-span-3  dark:bg-dark-blue dark:text-white">
                Units Per Hour&nbsp;:
              </label>
              <span className="uppercase text-sm md:text-lg xl:text-[1.5vw] 2xl:text-3xl font-semibold text-gray-500 justify-self-start ml-1  dark:bg-dark-blue dark:text-white">
            ...
            <h5 className="uppercase text-sm md:text-lg xl:text-[1.5vw] 2xl:text-3xl font-medium text-gray-800 mt-2 md:text-right xl:leading-6 grid-cols-4 grid justify-items-stretch  dark:bg-dark-blue dark:text-white">
          ...
          <h1
            className={`{ dark:bg-dark-blue dark:text-white text-[75px] md:text-[150px] lg:text-[155px] xl:text-[14vw] 2xl:text-[210px] font-semibold text-gray-300 leading-none mt-2}`}
          >
            {/* {unitsCreated < 10
              ?`00${unitsCreated}`
              : unitsCreated < 100
