...
const DeletePartModal = ({ isOpen, onClose, _id }: DeleteModalProps) => {
  const queryClient = useQueryClient()
  const { mutate, isLoading: isDeletePartLoading } = useDeletePart()
                ...
                <>
                  <div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      ...
                      >
                        Are you sure you want to remove this part? This action
                        is irreversible.
                      </Dialog.Title>
                    </div>
                  </div>
