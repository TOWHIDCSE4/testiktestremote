...
export default function DropDownMenu({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button
          className="flex items-center rounded-full bg-gray-200 bg-opacity-40 text-gray-700 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-dark-blue focus:ring-offset-2 focus:ring-offset-blue-100"
