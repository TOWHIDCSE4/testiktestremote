            ...
            <div className="lg:flex justify-between">
              <div className="w-[350px]">
                <div className="grid grid-cols-4 items-center gap-y-2">
                  ...
                  <select
                    id="machine-class"
                    className={`block col-span-2 md:mt-0 w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-700 font-medium ring-1 ring-inset ring-gray-300 focus:ring-1 focus:ring-blue-950 text-sm sm:leading-6`}
                    disabled={
                      isUpdatePartLoading ||
                      isPartDetailsLoading ||
                      isLocationsLoading ||
